# Архитектурная документация EZstudy

Дата: 2026-02-04

## 1. Краткое описание
EZstudy — кроссплатформенное Flutter-приложение для обучения по билетам. Пользователь проходит уровни, отвечает на вопросы, получает опыт и валюту, открывает новые билеты и элементы кастомизации. Прогресс и настройки сохраняются локально и могут синхронизироваться через минимальный backend.
