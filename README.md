...
EZstudy — приложение для подготовки по билетам в игровой форме. Проходите уровни, отвечайте на вопросы, копите опыт и монеты, открывайте новые билеты и элементы оформления.
...
## Конфиденциальность
EZstudy хранит прогресс и настройки локально на устройстве. При включении синхронизации данные сохраняются на сервере как конфигурация пользователя. Подробности см. в `privacy.md`.
